...
import { AppAuthError, useAuthSession, useSendEmailVerificationEmail } from '@/rng-platform';
...
import { RNGLoadingOverlay } from '../ux';
...
export function EmailVerificationScreen({
  ...
  const sendVerificationEmail = useSendEmailVerificationEmail();
