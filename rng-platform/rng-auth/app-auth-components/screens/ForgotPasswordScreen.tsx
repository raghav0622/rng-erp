...
import { sendPasswordResetEmailSchema } from '../../app-auth-hooks/schemas';
import { useSendPasswordResetEmail } from '../../app-auth-hooks/useAuthMutations';
 ...
 *
 * Features:
 * - Uses useSendPasswordResetEmail hook
 * - Schema validation via sendPasswordResetEmailSchema
 ...
 */
export function ForgotPasswordScreen({ header, footer }: ForgotPasswordScreenProps) {
